  ...
  return (
    <section className="bg-white py-20 md:py-28">
      <div className="mx-auto w-full max-w-7xl px-4 text-center sm:px-6">
        ...
        <Stagger className="mt-12 flex flex-wrap items-stretch justify-center gap-10 md:gap-16">
          {badges.map((badge) => (
        ...
        {settings.description && (
          <Reveal delay={0.15} className="mx-auto mt-14 max-w-3xl text-sm leading-relaxed text-text-muted md:text-base">
            {settings.description}
          </Reveal>
        )}
      </div>
